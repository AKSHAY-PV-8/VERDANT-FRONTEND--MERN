  ...
  return (
    <div className="min-h-screen min-w-screen bg-gray-900 text-gray-100">
      ...
      <nav className="fixed w-screen bg-gray-900/90 backdrop-blur-sm z-50 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 sm:fixed lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-green-300">Verdant Gis</h3>
                <p className="text-gray-300"></p>
                <div className='pt-6'>
                <a
                href=""
            ...
            <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-green-300">Project Reports</h3>
                <p className="text-gray-300"></p>
                <div className='pt-6'>
                <a
                href=""
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-xl">
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">contact@verdant.com</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="h-6 w-6 text-green-400 mr-4" />
                  <span className="text-gray-300">123 Agriculture Street, Farmland, FL 12345</span>
                </div>
              </div>
              <div className="mt-8">
                <img
